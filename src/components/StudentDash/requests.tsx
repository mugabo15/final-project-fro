...
const RequestNewDocument: React.FC<{ onSuccess?: () => void }> = ({onSuccess}) => {
    ...
    <div className="flex flex-col md:flex-row h-screen bg-white overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6">
          <h1 className="text-xl md:text-2xl font-medium mb-4 md:mb-6">Request New Document</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div>
                ...
                {/* File Upload */}
                <div className="mb-6">
                  <p className="font-medium mb-3">Upload your payment receipt <span className="text-red-500">*</span></p>
              ...
              <div className="border rounded-lg overflow-hidden">
                ...
                {myRequests.map((request, index) => (
                  <div key={index} className="grid grid-cols-2 p-4 border-b">
                    ...
                    <div className="text-right text-gray-500">{request.date}</div>
                  </div>
                ))}
              </div>
            </div>
