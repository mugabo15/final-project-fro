...
const ToWhomRequests = () => {
    ...
    const [setTranscript, TranscriptOpen] = useState(true);
                                ...
                                {menuItems.map((item) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={` flex  items-center justify-between p-4 rounded-xl transition-all duration-200 text-left group ${isActive
