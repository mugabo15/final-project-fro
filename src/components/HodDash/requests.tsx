...
export default function HRequstedDocs() {
  ...
  const fetchTranscriptRequests = async () => {
    try {
      ...
      const { data } = await axios.get(
        `http://localhost:7000/recomandation-request?documentType=${documentType}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleRejectRequest = async (requestId: string, reason: string) => {
    try {
      ...
      await axios.patch(
        `http://localhost:7000/recomandation-request/${requestId}/reject?role=${role}&reason=${encodeURIComponent(
          reason
        )}`,
        {},
        {
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans overflow-hidden">
      ...
      >
        <div className="p-6 text-xl font-bold text-blue-600 text-center">
            ...
            <div className="flex gap-6 mb-4">
              <div
                ...
                className={`text-sm font-bold ${
                  istranscripts ? "text-blue-900 underline" : "text-blue-700"
                } cursor-pointer`}
              >
                Transcripts
              </div>
              ...
              <div
                ...
                className={`text-sm font-bold ${
                  istoWhom ? "text-blue-900 underline" : "text-blue-700"
                } cursor-pointer`}
              >
                To Whom
              </div>
              ...
              <div
                ...
                className={`text-sm font-bold ${
                  isAttendance ? "text-blue-900 underline" : "text-blue-700"
                } cursor-pointer`}
              >
              ...
              <div
                ...
                className={`text-sm font-bold ${
                  isProofOfEnglish ? "text-blue-900 underline" : "text-blue-700"
                } cursor-pointer`}
              >
              ...
              <div
                ...
                className={`text-sm font-bold ${
                  isDegree ? "text-blue-900 underline" : "text-blue-700"
                } cursor-pointer`}
              >
                Degree(Diploma)
              </div>
                      ...
                      return (
                        <tr key={req.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-2">
                            {req.facultyId?.name || "N/A"}
                          </td>
                          <td className="px-4 py-2">
                            {req.departmentId?.name || "N/A"}
                          </td>
                          {/* {role === "recoveryOfficer" && ( */}
                            <td className="px-4 py-2">{req.price || "N/A"}</td>
                          {/* )} */}
